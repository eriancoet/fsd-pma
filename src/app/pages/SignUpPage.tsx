...
export function SignUpPage() {
  ...
  // Supabase can respond differently depending on your auth settings.
  // Catch the common "already registered" style messages.
  ...
  if (looksLikeExists) {
    ...
    // Keep it user-friendly (optionally neutral for security)
    setErrorMsg("It looks like you already have an account. Try signing in or reset your password.");
  } else {
  ...
  <div className="space-y-6">
    <div className="border rounded-xl p-4 text-sm text-gray-700">
      {alreadyExists ? (
        ...
        <>
          If email confirmation is enabled, we’ve sent a verification link to{" "}
